...
IMG_HEIGHT = 96
IMG_WIDTH = 256
NUM_SAMPLES = 1000 # Số pixel để huấn luyện
PIXELS_PER_IMAGE = IMG_HEIGHT * IMG_WIDTH

mem = psutil.virtual_memory()
if mem.available < 8 * 1024**3:
    NUM_SAMPLES = 500
    print(f"Cảnh báo: Giảm NUM_SAMPLES xuống {NUM_SAMPLES} do RAM thấp")

def extract_features(img_path, label_path, n_components=100):
